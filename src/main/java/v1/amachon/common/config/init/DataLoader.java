//package v1.amachon.common.config.init;
//
...
//
//        // 멤버
//        Member 이정우 = Member.ofMember(JoinRequest.builder().email("member1@naver.com").nickname("이정우").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 박종범 = Member.ofMember(JoinRequest.builder().email("member2@naver.com").nickname("박종범").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 전재욱 = Member.ofMember(JoinRequest.builder().email("member3@naver.com").nickname("전재욱").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 전승현 = Member.ofMember(JoinRequest.builder().email("member4@naver.com").nickname("전승현").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 허규범 = Member.ofMember(JoinRequest.builder().email("member5@naver.com").nickname("허규범").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 카리나 = Member.ofMember(JoinRequest.builder().email("member6@naver.com").nickname("카리나").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 윈터 = Member.ofMember(JoinRequest.builder().email("member7@naver.com").nickname("윈터").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 닝닝 = Member.ofMember(JoinRequest.builder().email("member8@naver.com").nickname("닝닝").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 지젤 = Member.ofMember(JoinRequest.builder().email("member9@naver.com").nickname("지젤").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 카즈하 = Member.ofMember(JoinRequest.builder().email("member10@naver.com").nickname("카즈하").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 김채원 = Member.ofMember(JoinRequest.builder().email("member11@naver.com").nickname("김채원").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 허윤진 = Member.ofMember(JoinRequest.builder().email("member12@naver.com").nickname("허윤진").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 사쿠라 = Member.ofMember(JoinRequest.builder().email("member13@naver.com").nickname("사쿠라").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 홍은채 = Member.ofMember(JoinRequest.builder().email("member14@naver.com").nickname("홍은채").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 장원영 = Member.ofMember(JoinRequest.builder().email("member15@naver.com").nickname("장원영").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 레이 = Member.ofMember(JoinRequest.builder().email("member16@naver.com").nickname("레이").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 안유진 = Member.ofMember(JoinRequest.builder().email("member17@naver.com").nickname("안유진").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 이서 = Member.ofMember(JoinRequest.builder().email("member18@naver.com").nickname("이서").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 가을 = Member.ofMember(JoinRequest.builder().email("member19@naver.com").nickname("가을").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 리즈 = Member.ofMember(JoinRequest.builder().email("member20@naver.com").nickname("리즈").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 하니 = Member.ofMember(JoinRequest.builder().email("member21@naver.com").nickname("하니").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 민지 = Member.ofMember(JoinRequest.builder().email("member22@naver.com").nickname("민지").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 해린 = Member.ofMember(JoinRequest.builder().email("member23@naver.com").nickname("해린").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 다니엘 = Member.ofMember(JoinRequest.builder().email("member24@naver.com").nickname("다니엘").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 혜인 = Member.ofMember(JoinRequest.builder().email("member25@naver.com").nickname("혜인").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 제니 = Member.ofMember(JoinRequest.builder().email("member26@naver.com").nickname("제니").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 리사 = Member.ofMember(JoinRequest.builder().email("member27@naver.com").nickname("리사").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 지수 = Member.ofMember(JoinRequest.builder().email("member28@naver.com").nickname("지수").password(passwordEncoder.encode("wjddn6138!")).build());
//        Member 로제 = Member.ofMember(JoinRequest.builder().email("member29@naver.com").nickname("로제").password(passwordEncoder.encode("wjddn6138!")).build());
//
...
//
//        // 메시지
//        sendMessageByMember(이정우, 카리나, new SendMessageRequest("카리나님 안녕하세요!"));
//        sendMessageByMember(카리나, 이정우, new SendMessageRequest("이정우님 안녕하세요~"));
//        sendMessageByMember(이정우, 카리나, new SendMessageRequest("프로젝트 같이 하실래요?"));
//        sendMessageByMember(카리나, 이정우, new SendMessageRequest("어떤 스택 사용하나요?"));
//        sendMessageByMember(이정우, 카리나, new SendMessageRequest("스프링이랑 리액트 사용해서 웹 만드려구요!"));
//        sendMessageByMember(허윤진, 이정우, new SendMessageRequest("정우님 안녕하세요~ 혹시 프론트엔드 팀 구하셨나요?"));
//        sendMessageByMember(이정우, 허윤진, new SendMessageRequest("한자리 남았어요! 같이 하실래요?"));
//        sendMessageByMember(허윤진, 이정우, new SendMessageRequest("오 좋습니다! 참가 신청할게요!"));
//        sendMessageByMember(박종범, 이정우, new SendMessageRequest("야 정우야 프론트엔드 팀원좀 구해줘"));
//        sendMessageByMember(이정우, 박종범, new SendMessageRequest("지금 구하고있어ㅋㅋ 좀만 기달"));
//        sendMessageByMember(박종범, 이정우, new SendMessageRequest("살려줘.."));
//        sendMessageByMember(이정우, 전재욱, new SendMessageRequest("재욱아 디자인좀 부탁하자"));
//        sendMessageByMember(전재욱, 이정우, new SendMessageRequest("ㅋㅋㅇㅋ 뭐하면 되는데"));
//        sendMessageByMember(박종범, 전승현, new SendMessageRequest("승현아 깃 에러나는데 수정좀"));
//        sendMessageByMember(전승현, 박종범, new SendMessageRequest("ㅇㅋㅇㅋ"));
//        sendMessageByMember(박종범, 허규범, new SendMessageRequest("규범아 작업한거 깃에 푸시해주라"));
//        sendMessageByMember(전재욱, 카즈하, new SendMessageRequest("카즈하님 혹시 프로젝트 같이 하실래요? 프론트엔드 한자리가 남아서요."));
//        sendMessageByMember(카즈하, 전재욱, new SendMessageRequest("아 죄송합니다.. 이미 프로젝트 구해서요ㅠㅠ"));
//        sendMessageByMember(전재욱, 카즈하, new SendMessageRequest("아.. 넵!!!"));
//        sendMessageByMember(전승현, 이서, new SendMessageRequest("이서야 안녕"));
//        sendMessageByMember(이서, 전승현, new SendMessageRequest("누구세요..?"));
//        sendMessageByMember(전승현, 이서, new SendMessageRequest("아 잘못보냈네요. 죄송합니다."));
//        sendMessageByMember(윈터, 박종범, new SendMessageRequest("종범님 안녕하세요!"));
//        sendMessageByMember(윈터, 박종범, new SendMessageRequest("혹시 프론트엔드 자리있나요!?"));
//        sendMessageByMember(박종범, 윈터, new SendMessageRequest("리액트 한자리 남았습니다! 참가 신청 바로 하시면 될거같아요!"));
//        sendMessageByMember(윈터, 박종범, new SendMessageRequest("넹"));
//        sendMessageByMember(레이, 허규범, new SendMessageRequest("규범님 안녕하세요. 혹시 게임 개발 같이하실래요?"));
//        sendMessageByMember(허규범, 레이, new SendMessageRequest("안녕하세요! 무슨 게임 개발하시나요??"));
//        sendMessageByMember(레이, 허규범, new SendMessageRequest("FPS 게임 만들고 싶은데 규범님은 무슨 게임 좋아하세요?"));
//        sendMessageByMember(허규범, 레이, new SendMessageRequest("오 저도 FPS 게임 좋아하는데!! 간단한거라도 같이 해보실래요?"));
//        sendMessageByMember(레이, 허규범, new SendMessageRequest("좋아요~"));
//        sendMessageByMember(장원영, 이정우, new SendMessageRequest("안녕하세요 정우님~ 혹시 프론트엔드 플러터도 사용하실까요?"));
//        sendMessageByMember(이정우, 장원영, new SendMessageRequest("아.. 아직 플러터는 사용 예정이 없습니다ㅠㅠ"));
//        sendMessageByMember(장원영, 이정우, new SendMessageRequest("아 넵 알겠습니다ㅠㅠ"));
//        sendMessageByMember(이정우, 장원영, new SendMessageRequest("플러터 사용하게 된다면 연락드릴게요!"));
//        sendMessageByMember(장원영, 이정우, new SendMessageRequest("네~"));
//        sendMessageByMember(박종범, 레이, new SendMessageRequest("레이님 안녕하세요~ 디자이너 구하고 있는데 혹시 하실 생각 있으세요!?"));
//        sendMessageByMember(레이, 박종범, new SendMessageRequest("아 죄송해요.. 게임 개발 하기로해서ㅠㅠ 다음에 같이해요!"));
//        sendMessageByMember(박종범, 레이, new SendMessageRequest("앗 넵!!"));
//        sendMessageByMember(박종범, 지수, new SendMessageRequest("안녕하세요~ 저희가 디자이너가 구하고 있는데 혹시 참여 하실 생각 있으신가용?"));
//        sendMessageByMember(지수, 박종범, new SendMessageRequest("오 좋아요!! 프로젝트 아이디어가 좋은거같아요 ㅎㅎ"));
//        sendMessageByMember(박종범, 지수, new SendMessageRequest("감사합니다ㅎㅎ 참가 신청 해주시면 바로 수락해드릴게요!"));
//        sendMessageByMember(지수, 박종범, new SendMessageRequest("앗 알겠습니다~"));
//        sendMessageByMember(전승현, 리즈, new SendMessageRequest("리즈님 안녕하세요. 혹시 저희 프로젝트 참여 하실 생각있으신가요?"));
//        sendMessageByMember(리즈, 전승현, new SendMessageRequest("혹시 장고로 프로젝트 하는거 맞나요?"));
//        sendMessageByMember(전승현, 리즈, new SendMessageRequest("넵 맞습니다! 리즈님이 디자인 해주실 수 있을까요?"));
//        sendMessageByMember(리즈, 전승현, new SendMessageRequest("디자인을 최근에 배워서.. 그래도 괜찮을까요?!"));
//        sendMessageByMember(전승현, 리즈, new SendMessageRequest("괜찮습니다ㅎㅎ 같이 배우면서 해요~"));
//        sendMessageByMember(리즈, 전승현, new SendMessageRequest("좋아요~~~"));
//        sendMessageByMember(해린, 전재욱, new SendMessageRequest("재욱님 안녕하세요!! 백엔드 한 명이 부족해서 혹시 같이 프로젝트 하실래용?"));
//        sendMessageByMember(전재욱, 해린, new SendMessageRequest("오 좋습니다! 프론트엔드는 어떤 프레임워크 사용하나요?"));
//        sendMessageByMember(해린, 전재욱, new SendMessageRequest("Swift나 Android 사용할 것 같아요!"));
//        sendMessageByMember(전재욱, 해린, new SendMessageRequest("네 알겠습니다~ 참가 신청 할게요!"));
//
//        // 프로젝트
...
////                .leader(카즈하).regionTag(강남구).recaruitDeadline(LocalDate.now()).recruitNumber(4).developPeriod(LocalDate.now().plusDays(30L)).build();
...
////        teamMemberRepository.save(new TeamMember(project1, 해린));
...
//            projectTechTagRepository.save(new ProjectTechTag(project, aws));
//            projectTechTagRepository.save(new ProjectTechTag(project, spring));
//            projectTechTagRepository.save(new ProjectTechTag(project, mySQL));
//            teamMemberRepository.save(new TeamMember(project, 카즈하));
//            teamMemberRepository.save(new TeamMember(project, 카리나));
//            teamMemberRepository.save(new TeamMember(project, 윈터));
//            teamMemberRepository.save(new TeamMember(project, 장원영));
//            teamMemberRepository.save(new TeamMember(project, 해린));
//        }
//    }
//
//    public void sendMessageByMember(Member from, Member to, SendMessageRequest sendMessageDto) {
